...
export class OpensearchModule implements OnApplicationShutdown {
  ...
  public static forRoot(
    options: OpensearchClientOptions | OpensearchClientOptions[],
  ): DynamicModule {
  ...
  public static forRootAsync(
    options: OpensearchAsyncClientOptions,
  ): DynamicModule;
  ...
  public static forRootAsync(
    options: OpensearchAsyncClientOptions | OpensearchAsyncClientOptions[],
  ): DynamicModule {
